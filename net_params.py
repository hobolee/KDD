...
convgru_encoder_params = [
    ...
    [
        CGRU_cell(shape=(137), input_channels=8, filter_size=5, num_features=16),
        CGRU_cell(shape=(69), input_channels=16, filter_size=5, num_features=32),
        CGRU_cell(shape=(35), input_channels=32, filter_size=5, num_features=64)
    ]
]

convgru_decoder_params = [
    [
        OrderedDict({'deconv1_leaky_1': [64, 64, 4, 2, 2]}),
        OrderedDict({'deconv2_leaky_1': [32, 32, 4, 2, 2]}),
        OrderedDict({
            'deconv3_leaky_1': [16, 16, 3, 1, 1],
            'conv4_no_1': [16, 1, 1, 1, 0]
        }),
    ],

    [
        CGRU_cell(shape=(35), input_channels=64, filter_size=5, num_features=64),
        CGRU_cell(shape=(69), input_channels=64, filter_size=5, num_features=32),
        CGRU_cell(shape=(137), input_channels=32, filter_size=5, num_features=16),
    ]
]
